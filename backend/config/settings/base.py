...
# Booking System Health Monitoring
BOOKING_HEALTH_ALERT_FAILED_SYNCS_THRESHOLD = config('BOOKING_HEALTH_ALERT_FAILED_SYNCS_THRESHOLD', default=10, cast=int)
BOOKING_HEALTH_ALERT_DIRTY_CACHE_THRESHOLD = config('BOOKING_HEALTH_ALERT_DIRTY_CACHE_THRESHOLD', default=100, cast=int)
